...
export default function NewProductForm() {
  return (
    <>
      <div className="bg-gray-100 font-sans drop-shadow-lg m-0">
        <div className="bg-white shadow ">
          <div className="container mx-auto px-2 ">
            ...
            <div className="block sm:hidden bg-white border-t-2 py-2"></div>
          </div>
        </div>
      </div>
      <div class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-800 dark:text-gray-100">
        <div class="flex flex-col justify-between">
          <img src={foto} alt="" style={{ width: 500, marginTop: 120, paddingRight: 50 }} />
        </div>
