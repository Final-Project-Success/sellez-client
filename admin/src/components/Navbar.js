...
export default function Navbar() {
  return (
    <>
      <div className="bg-gray-100 font-sans drop-shadow-lg w-full m-0">
        <div className="bg-white shadow">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between py-4">
              ...
              localStorage.clear()
             }} className="text-blue-500 text-sm font-semibold hover:text-yellow-400 ease-linear transition-all duration-200">
