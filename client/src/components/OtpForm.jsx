...
<div class="antialiased font-nunito bg-blue-100 flex items-center justify-center h-screen">
    ...
    <div class="container px-4 sm:px-8 mx-auto max-w-lg">
        ...
        <div class="wrapper bg-white rounded-sm shadow-lg">
            ...
            <div class="card px-8 py-4">
                ...
                <div class="card-text">
                    <h1 class="text-xl md:text-2xl font-bold leading-tight text-gray-900">Check your email!</h1>
                    <p class="text-base md:text-lg text-gray-700 mt-3 ">insert your Verification Code!</p>
                </div>

                <div class="card-mail flex items-center my-10">
                    <input type="email" class="border-l border-t border-b border-gray-200 rounded-l-md w-full text-base md:text-lg px-3 py-2" placeholder="Enter OTP"/>
                    <Link to='/login'>
                    
                    <button class="bg-blue-500 hover:bg-blue-600  text-white font-bold capitalize px-3 py-2 text-base md:text-lg rounded-r-md border-t border-r border-b border-yellow-300">Send</button>
                    </Link>
                </div>
            </div>
        </div>
